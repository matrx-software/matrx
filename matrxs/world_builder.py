...
class WorldBuilder:
    ...
    def __init__(self, shape, tick_duration=0.5, random_seed=1, simulation_goal=1000, run_sail_api=False,
        ...
        Create a WorldBuilder that creates defaults worlds of 5 tiles wide and high.

            >>> from matrxs.world_builder import WorldBuilder
            >>> wb = WorldBuilder([5,5])
            >>> wb
            <matrxs.world_builder.WorldBuilder object at 0x000001ABDE433CF8>

        Create a WorldBuilder that creates worlds with an unlimited fast tick and that runs for 50 000 ticks.

            >>> from matrxs.world_builder import WorldBuilder
            >>> wb = WorldBuilder([5,5], tick_duration=-1, simulation_goal=50000, visualization_bg_clr="#000000")
            >>> wb
            <matrxs.world_builder.WorldBuilder object at 0x000001ABDE433D30>
