...
def create_builder():
    ...
    factory.add_room(top_left_location=[0, 0],
                     width=14, height=20, name="world_bounds")
    ...
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       0, 0], is_traversable=True, visualize_colour="#c0392b", visualize_shape=2)
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       0, 1], is_traversable=True, visualize_colour="#9b59b6", visualize_shape=1)
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       0, 2], is_traversable=True, visualize_colour="#2980b9", visualize_shape=0)
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       1, 0], is_traversable=True, visualize_colour="#1abc9c", visualize_shape=2, visualize_size=0.75)
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       1, 1], is_traversable=True, img_name="/static/images/fire.gif")
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       1, 2], is_traversable=True, visualize_colour="#27ae60", visualize_shape=0)
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       2, 0], is_traversable=True, visualize_colour="#f1c40f", visualize_shape=2, visualize_size=0.5)
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       2, 1], is_traversable=True, visualize_colour="#e67e22", visualize_shape=1)
    factory.add_object([6, 7], "block", subtiles=[3, 3], subtile_loc=[
                       2, 2], is_traversable=True, visualize_colour="#2e4053", visualize_shape=0)
    ...
    # add loggers
    factory.add_logger(MessageLogger, save_path=log_folder,
                       file_name_prefix="messages_")
...
def run_vis_test(nr_of_worlds=2):
    ...
    # set our path for media files to our current folder
